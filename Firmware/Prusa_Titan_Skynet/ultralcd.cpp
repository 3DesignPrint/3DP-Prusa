...
KeepDrawing:
  ...
  void lcd_quick_feedback() {
    lcdDrawUpdate = LCDVIEW_CLEAR_CALL_REDRAW;
    buttons = 0;
    next_button_update_ms = millis() + 500; //Original Value 500

    // Buzz and wait. The delay is needed for buttons to settle!
    lcd_buzz(LCD_FEEDBACK_FREQUENCY_DURATION_MS, LCD_FEEDBACK_FREQUENCY_HZ);
    #if ENABLED(LCD_USE_I2C_BUZZER)
      delay(10); //original value 10
    #elif PIN_EXISTS(BEEPER)
        ...
        uint8_t newbutton = 0;
          ...
          if (false) {
            // for the else-ifs below
              ...
              next_button_update_ms = now + 300; //original value 300
            }
          #endif
          #if BUTTON_EXISTS(DWN)
...
#if ENABLED(ADC_KEYPAD)
#define	ADC_KEY_NUM		8 //original 8
typedef struct
{
...
_stADCKeypadTable_ stADCKeyTable[ADC_KEY_NUM] =
{
  ...
  #elif defined ZONESTAR_KEYPAD_LCD //ZONESTAR_KEYPAD_LCD
    //VALUE_MIN, VALUE_MAX , KEY
    { 2000*2,2048, BLEN_REPRAPWORLD_KEYPAD_F1 + 1 },    //F1
    { 2000*2,2048*2, BLEN_REPRAPWORLD_KEYPAD_F2 + 1 },    //F2
    { 2000*2,2048*2, BLEN_REPRAPWORLD_KEYPAD_F3 + 1 },    //F3
    { 130*2,230*2,  BLEN_REPRAPWORLD_KEYPAD_LEFT + 1 }, //LEFT
    { 970*2,1070*2, BLEN_REPRAPWORLD_KEYPAD_RIGHT + 1 },  //RIGHT // dirty fix
    //{ 1340,1440,  BLEN_REPRAPWORLD_KEYPAD_UP + 1 },   //UP //dirty fix UP and DOWN seems to be swapped, so I swapped them 
    //{ 300,400, BLEN_REPRAPWORLD_KEYPAD_DOWN + 1 },  //DOWN 
    { 1340*2,1440*2,  BLEN_REPRAPWORLD_KEYPAD_DOWN + 1 },   //UP 
    { 300*2,400*2, BLEN_REPRAPWORLD_KEYPAD_UP + 1 },  //DOWN
    { 600*2,700*2, BLEN_REPRAPWORLD_KEYPAD_MIDDLE + 1 },  //ENTER
   #endif
