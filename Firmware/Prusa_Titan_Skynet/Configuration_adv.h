...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {3000, 3000, 1000, 1000} // Feedrates for manual moves along X, Y, Z, E from panel
...
#define FILAMENT_CHANGE_FEATURE
  ...
  #define FILAMENT_CHANGE_X_POS 211            // X position of hotend
  #define FILAMENT_CHANGE_Y_POS 0              // Y position of hotend
  #define FILAMENT_CHANGE_Z_ADD 2              // Z addition of hotend (lift)
  #define FILAMENT_CHANGE_XY_FEEDRATE 50       // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
  #define FILAMENT_CHANGE_Z_FEEDRATE 15        // Z axis feedrate in mm/s (not used for delta printers)
  #define FILAMENT_CHANGE_RETRACT_LENGTH 2     // Initial retract in mm
                                               // It is a short retract used immediately after print interrupt before move to filament exchange position
  #define FILAMENT_CHANGE_RETRACT_FEEDRATE 400   // Initial retract feedrate in mm/s
  #define FILAMENT_CHANGE_UNLOAD_LENGTH 80     // Unload filament length from hotend in mm
                                              // Longer length for bowden printers to unload filament from whole bowden tube,
                                              // shorter lenght for printers without bowden to unload filament from extruder only,
                                              // 0 to disable unloading for manual unloading
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE 400  // Unload filament feedrate in mm/s - filament unloading can be fast
  #define FILAMENT_CHANGE_LOAD_LENGTH  70      // Load filament length over hotend in mm
  ...
  #define FILAMENT_CHANGE_EXTRUDE_FEEDRATE 2  // Extrude filament feedrate in mm/s - must be slower than load feedrate
  //*added to be able to compile prog
